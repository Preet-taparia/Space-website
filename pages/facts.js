...
const Facts = ({ bodies }) => {
  return (
    <section className={`${styles.paddings} relative z-10 min-h-screen star-bg pt-28`}>
      ...
      >
        <TypingText title="| The Encyclopedia" textStyles="text-center" />
        <TitleText title={<>Solar System <span className="text-[#a509ff]">Data Lab</span></>} textStyles="text-center mb-16" />

        <motion.div
          variants={fadeIn('up', 'tween', 0.1, 1)}
          className="mb-12 glassmorphism p-8 rounded-[32px] border-[#a509ff]/20 text-center"
        >
          <p className="text-white font-medium text-[22px] italic">
            &quot;Science provides the data, but the telescope provides the connection. I share these facts to help you understand the scale of what we observe every night.&quot;
          </p>
          <p className="text-secondary-white text-sm mt-2">— Aaditya, Star Titan</p>
        </motion.div>
            ...
            {bodies.map((body, index) => (
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  <div className="mt-6 pt-6 border-t border-white/10 uppercase tracking-tighter">
                    <p className="text-[10px] text-[#a509ff] font-bold mb-1">Star Titan Insight:</p>
                    <p className="text-[12px] text-gray-300">
                      {body.isPlanet
                        ? `Best seen at opposition. Use high power magnification.`
                        : `Look for this during the next planetary transit or eclipse.`}
                    </p>
                  </div>
                  ...
                  <div className="mt-4 pt-4 border-t border-white/10 flex items-center justify-between">
                    ...
                    <a
                      href={`https://youtube.com/@StarTitan?search_query=${body.englishName}`}
                      target="_blank"
                      className="text-[#a509ff] text-[11px] font-bold hover:underline"
                    >
                      Watch Guide &rarr;
                    </a>
                  </div>
